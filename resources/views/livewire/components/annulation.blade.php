<div class=" flex flex-col bg-white  min-h-screen" style="height: 932px; width :450px;">
    ...
    <div class="bg-white2  "
        ...
        <div class="pl-5  pt-9">
            <div class="text-backSingin font-semibold  text-2xl text-center"> We cannot confirm your</div>
        </div>
        <div class="bg-white2  "
            style="background-image: url('{{ asset('images/imageannulation.png') }}'); background-size: cover;       height: 102px ; width:117px ;  margin-left:150px;  margin-top:120px ;  ">

        </div>
        <div class=" pt-24 text-backSingin font-semibold  text-2xl text-center">
            reservation, unless you make a change the reservation is canceled.
        </div>
    ...
    <div style="margin-top:30px; margin-left:150px ">
        <button wire:click="" class="bg-white text-backSingin font-bold text-2xl-center rounded shadow
        "
