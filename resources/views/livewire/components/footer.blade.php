<footer 
    class="bg-white rounded-lg shadow sm:flex sm:ml-64 sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2024-2025 <a href="#" class="hover:underline" target="_blank">InnovGuide</a>. All
        rights reserved.
    </p>
