...
class PropertyAttributeFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'room_type' => $this->faker->randomElement(['Maison', 'Appartement', 'Studio', 'Chambre']),
            ...
            'present' => $this->faker->numberBetween(1, 9),
            'break_fast' => $this->faker->numberBetween(1, 9),
            'surprise' => $this->faker->numberBetween(1, 9),
        ];
    }
}
