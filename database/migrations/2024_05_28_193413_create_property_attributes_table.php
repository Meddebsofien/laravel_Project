...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('property_attributes', function (Blueprint $table) {
            ...
            $table->string('room_type')->nullable(); // Peut être null
            ...
            $table->integer('bathroom')->nullable(); // Peut être null
            $table->string('currency')->default('EUR'); // 'currency' par défaut à 'EUR'
            ...
            $table->integer('break_fast')->nullable();
            $table->integer('surprise')->nullable();
            $table->timestamps();
        });
